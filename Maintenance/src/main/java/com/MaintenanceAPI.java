...
public class MaintenanceAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = maintainObj.insertItem(	request.getParameter("id"),
											request.getParameter("area"),
											request.getParameter("gridName"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = maintainObj.updateItem(	paras.get("hidcompIDSave").toString(),
											paras.get("id").toString(),
											paras.get("area").toString(),
											paras.get("gridName").toString(),
